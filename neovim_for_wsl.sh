...
in your ~/.bashrc so that neovim becomes your default editor (the VISUAL trick is
meant specifically to be able to <C-x><C-e> in a neovim terminal so that it opens a temporary 
buffer to edit your command but avoid the 'vim in vim' issue.
EOF
