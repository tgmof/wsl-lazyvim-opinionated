return {
  -- Problem this solves: Use a neovim terminal with a long command, press <C-x><C-e> and it opens your default editor (setup in bashrc using EDITOR=nvim) which results in a vim in vim issue.
